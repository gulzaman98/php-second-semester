...
?>
	...
	if(isset($_SESSION['user_id'])){
		...
		on add_product.p_id = add_to_cart.pro_id WHERE
								...
								<tr class="table_row">
									<td class="column-1">
										<div class="how-itemcart1">
											<img src="/gulzaman-2nd-semester-php/class-26/admin_panel/images/<?php echo $cart['p_image'] ?>" alt="IMG">
										</div>
									</td>
									<td class="column-2"><?php echo $cart['p_name'] ?></td>
